# PLNM - 基于智能体协作的学习生活一体化管理系统

> 毕业设计项目 | 全栈 Web 应用 | 多角色 AI 智能体协作

PLNM（Personal Learning and Life Management）是一个集成笔记管理、消费记账、学习进度追踪与多角色 AI 智能体协作的个人管理系统。系统通过 5 个 AI 角色（系统操作员、笔记助手、生活管家、学习导师、创作搭档）为用户提供智能化的操作执行、知识问答和创意辅助。
